        ...
        <section className="about-me bg-[#011627]  border-black border-2 grid grid-cols-1 md:grid-cols-2 gap-4 md:h-[680px] p-4 md:p-0">
          <div className="about-me-text flex flex-col justify-center items-center md:items-start  md:text-left md:ml-16 space-y-4  p-4">
            ...
            <div className="text-center md:text-left">
             ...
             "
              >
                I have working at part-time 7-11 in thailand and i want to
                create a website for learning programming for enhance my skill
                and have fun with new technology. in future want to be
                full-stack development and create pos for my restaurant
              </p>
            </div>
          </div>
